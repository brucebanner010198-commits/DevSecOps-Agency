...
| **Amazon** (`16`) | ✗ | ✗ | ◑ | ✗ | ✗ | Managed payment/shopping agent, cloud-locked |
| **Anthropic** (`16`) | ◑ (2-tier) | ✗ | ◑ | ◑ (permissions) | ✗ | Claude Code + MCP standard |
| **Apple Intelligence** (`16`) | ✗ | ✗ | ✅ (real OS) | ◑ (PQC iMessage) | ✗ (Apple-locked) | Native OS assistant, private cloud compute |
...
| **OpenAI** (`16`) | ◑ (2-tier) | ✗ | ◑ | ◑ | ✗ | ChatGPT Operator + AgentKit builder |
