...
- **Role:** Specialist
- **Reports to:** `cro`
- **Team:** 3 peers: `market-researcher`, `tech-scout`, `literature-reviewer`
- **Model tier:** `haiku`
- **Purpose:** Use this agent when the PM Lead needs personas and jobs-to-be-done derived from a project intake.
- **Convened by:** `cro`
