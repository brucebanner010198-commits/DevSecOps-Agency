...
- **Role:** Specialist
- **Reports to:** `cro`
- **Team:** 3 peers: `market-researcher`, `literature-reviewer`, `user-researcher`
- **Model tier:** `haiku`
- **Purpose:** Use this agent when the CRO needs a scan of the current technical landscape — standard stacks, libraries, patterns, and known-broken paths for the problem domain.
- **Convened by:** `cro`
- **Must not:** See `councils/research/AGENTS.md > ## Must not`
