...
- **Role:** Specialist
- **Reports to:** `cro`
- **Team:** 3 peers: `tech-scout`, `literature-reviewer`, `user-researcher`
- **Model tier:** `haiku`
- **Purpose:** Use this agent when the CRO needs a quick market scan for the idea — audience size, direct competitors, unmet niches.
- **Convened by:** `cro`
