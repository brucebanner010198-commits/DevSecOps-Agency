...
- **Role:** Specialist
- **Reports to:** `cro`
- **Team:** 3 peers: `market-researcher`, `tech-scout`, `user-researcher`
- **Model tier:** `haiku`
- **Purpose:** Use this agent when the CRO needs prior-art surfaced — past attempts, public post-mortems, design patterns, and known failure modes for this kind of project.
- **Convened by:** `cro`
