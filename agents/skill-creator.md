...
assistant: "skill-creator will author agents/mobile-dev.md (Execution council, blue) + optional skills/mobile-dev-kit/SKILL.md, return for CEO approval before first dispatch."
<commentary>
