...
- **Team:** 3 peers: `backend-dev`, `frontend-dev`, `integrations-engineer`
- **Model tier:** `haiku`
- **Purpose:** Use this agent when the VP-Eng (engineering-lead) needs database code — migrations, seed scripts, repository/query layer — matching the data-architect's design.
