...
- **Team:** 3 peers: `backend-dev`, `db-engineer`, `integrations-engineer`
- **Model tier:** `haiku`
- **Purpose:** Use this agent when the Engineering Lead needs client-side code implemented from the architecture document — UI, state management, API integration, and accessibility.
