...
- **Team:** 3 peers: `backend-dev`, `frontend-dev`, `db-engineer`
- **Model tier:** `haiku`
- **Purpose:** Use this agent when the VP-Eng (engineering-lead) needs third-party integrations wired up — auth providers, payment, email, object storage, external APIs.
