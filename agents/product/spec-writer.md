...
- **Role:** Specialist
- **Reports to:** `pm-lead`
- **Team:** 2 peers: `product-strategist`, `roadmap-planner`
- **Model tier:** `haiku`
- **Purpose:** Use this agent when the PM Lead needs a functional specification with testable acceptance criteria and measurable success metrics derived from the brief and personas.
- **Convened by:** `pm-lead`
