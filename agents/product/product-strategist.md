...
- **Role:** Specialist
- **Reports to:** `pm-lead`
- **Team:** 2 peers: `spec-writer`, `roadmap-planner`
- **Model tier:** `haiku`
- **Purpose:** Use this agent when the CPO (pm-lead) needs a crisp strategic framing — positioning, wedge, what to cut, what to keep — before the spec is written.
- **Convened by:** `pm-lead`
