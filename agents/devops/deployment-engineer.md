...
- **Team:** 2 peers: `ci-engineer`, `observability-engineer`
- **Model tier:** `haiku`
- **Purpose:** Use this agent when the DevOps Lead needs a container/IaC, deploy checklist, and rollback plan tuned to the chosen deployment target.
