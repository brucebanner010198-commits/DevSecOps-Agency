...
- **Team:** 6 peers: `eval-designer`, `benchmark-runner`, `regression-detector`, `token-compactor`, `finops-analyst`, `skill-evaluator`
- **Model tier:** `haiku`
- **Purpose:** Use this agent to track token + dollar burn against a project's declared budget and surface overruns early.
