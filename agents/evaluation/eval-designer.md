...
- **Team:** 6 peers: `benchmark-runner`, `regression-detector`, `budget-monitor`, `token-compactor`, `finops-analyst`, `skill-evaluator`
- **Model tier:** `haiku`
- **Purpose:** Use this agent to design an eval set from a project's OKRs + brief + shipped artifacts.
