...
- **Team:** 7 peers: `threat-modeler`, `code-auditor`, `pen-tester`, `dlp-scanner`, `mcp-defender`, `sbom-slsa`, `secrets-vault`
- **Model tier:** `haiku`
- **Purpose:** Use this agent when the CISO (security-lead) needs a compliance posture review — what frameworks apply, what controls are in scope, what's missing — given the data and deployment geography.
