...
- **Team:** 7 peers: `threat-modeler`, `code-auditor`, `pen-tester`, `compliance-officer`, `dlp-scanner`, `mcp-defender`, `secrets-vault`
- **Model tier:** `haiku`
- **Purpose:** Security Council specialist (Wave 7).
