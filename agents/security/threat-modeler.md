...
- **Team:** 7 peers: `code-auditor`, `pen-tester`, `compliance-officer`, `dlp-scanner`, `mcp-defender`, `sbom-slsa`, `secrets-vault`
- **Model tier:** `haiku`
- **Purpose:** Use this agent when the Security Lead needs a STRIDE threat model and OWASP Top 10 coverage analysis derived from a product brief.
