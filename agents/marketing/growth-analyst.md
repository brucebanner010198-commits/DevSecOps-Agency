...
- **Role:** Specialist
- **Reports to:** `cmo`
- **Team:** 3 peers: `positioning-strategist`, `comms-writer`, `brand-guardian`
- **Model tier:** `haiku`
- **Purpose:** Use this agent when the CMO needs activation / retention / monetisation targets for a project, or a growth-loop sketch.
- **Convened by:** `cmo`
