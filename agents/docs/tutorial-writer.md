...
- **Team:** 2 peers: `api-documenter`, `readme-writer`
- **Model tier:** `haiku`
- **Purpose:** Use this agent when the CKO (docs-lead) needs a "getting started" tutorial — a step-by-step walkthrough that takes a new user from zero to a working example.
