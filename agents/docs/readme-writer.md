...
- **Team:** 2 peers: `api-documenter`, `tutorial-writer`
- **Model tier:** `haiku`
- **Purpose:** Use this agent when the Docs Lead needs a polished top-level README for the generated project — overview, quick start, configuration, test, deploy, troubleshooting, and a security note.
