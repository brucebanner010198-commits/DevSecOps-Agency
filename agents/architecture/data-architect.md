...
- **Team:** 3 peers: `system-architect`, `api-designer`, `infra-architect`
- **Model tier:** `haiku`
- **Purpose:** Use this agent when the CTO (engineering-lead) needs the data model — entities, relationships, indexes, retention, PII classification.
