...
- **Role:** Specialist
- **Reports to:** `qa-lead`
- **Team:** 3 peers: `test-runner`, `performance-tester`, `a11y-auditor`
- **Model tier:** `haiku`
- **Purpose:** Use this agent when the QA Lead needs a test matrix derived from the acceptance criteria — what to test, at what level (unit/integration/e2e), and the priority order.
- **Convened by:** `qa-lead`
